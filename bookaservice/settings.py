...
MIDDLEWARE = [
    ...
    "whitenoise.storage.CompressedMainfestStaticFilesStorage" #whitenoise
...
STATICFILES_STORAGE = "whitenoise.storage.CompressedMainfestStaticFilesStorage" #whitenoise
